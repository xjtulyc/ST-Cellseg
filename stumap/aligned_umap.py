...
from stumap.sparse import arr_intersect as intersect1d
from stumap.sparse import arr_union as union1d
from stumap.umap_ import UMAP, make_epochs_per_sample
from stumap.spectral import spectral_layout
from stumap.layouts import optimize_layout_aligned_euclidean
...
class AlignedUMAP(BaseEstimator):
    ...
    def fit(self, X, y=None, **fit_params):
        ...
        for i in trange(1, self.n_models_):
        ...
        for i, embedding in trange(enumerate(self.embeddings_)):
