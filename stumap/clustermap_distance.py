...
from data_preprocess.preprocess import dataloader_STARmap_MousePlacenta
...
#             self.X_data = np.array(self.spots[['spot_location_1', 'spot_location_2', 'spot_location_3']])
#         else:
#             self.radius = self.xy_radius
#             self.X_data = np.array(self.spots[['spot_location_1', 'spot_location_2']])
#
#     def __len__(self):
...
# np.save('Xdata.npy', get_ClusterMap_distance.X_data)
# with open('ngc.pkl', 'wb') as f:
#     pickle.dump(ngc, f)
#     pass
# sparse.save_npz('ngc.npz', get_ClusterMap_distance.ngc)
